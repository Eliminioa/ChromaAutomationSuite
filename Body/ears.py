#######################################################################
# This bit here is the oldest part of the Chroma Automation Suite,    |
# originating back in late October - early November of 2014. I        |
# decided to put this comment here as a sort of nostalgic plaque      |
# to remember the history of this mess of code. It was originally     |
# a totally not-automatic deal, just a really rough python script     |
# integrated a bit with PRAW to literally just look through some      |
# comments to form a list of users, then send out a PM message. Its   |
...
class alertBot(object):
    ...
    to do with them."""
    def __init__(self,cfg,log, name):
        self.cfg = cfg
        self.log = log
        self.name = name
